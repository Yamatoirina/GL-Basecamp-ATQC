...
public class NotePad {
    ...
    @Step
    public NotePad openApplication() {
        driver.get("https://anotepad.com/");
        return this;
    }

    @Step
    public NotePad setNoteTitle(String title) {
        driver.findElement(noteTitle).sendKeys(title);
        return this;
    }

    @Step
    public NotePad addNoteContent(String content) {
        driver.findElement(noteContent).sendKeys(content);
        return this;
    }

    @Step
    public NotePad resetNoteContent(String content) {
